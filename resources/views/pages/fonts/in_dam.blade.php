...
@section('content')
    <div class="main-content">
        <h2>Tạo chữ in đậm trên facebook nhanh nhất</h2>
        <p>
        ...
        <p><b>Gõ chữ muốn in đậm làm Status Facebook/Yahoo:</b></p>
        ...
        <p>Hãy copy chữ in đậm này và paste vào hộp status đăng lên FaceBook hoặc chat Yahoo</p>
    </div>
@endsection
